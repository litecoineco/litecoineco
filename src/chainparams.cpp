...
{
    const char* pszTimestamp = "TheWashingtonPost 14/Jun/2018 Russia vs. Saudi Arabia: Hosts coast to 5-0 thumping in opener";
    const CScript genesisOutputScript = CScript() << ParseHex("046BB8DEFDE4F3FAC31902A35EB8DC1A3DF350DADE5BEBE1286B529CD21B0820522A1F09558A393981E590A34FEA27106D1C42D5D8388E558C4907985A49431B91") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1317972665, 2085106042, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.litecoineco.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("litecoinecotools.com", "dnsseed.litecoinecotools.com"));
        //vSeeds.push_back(CDNSSeedData("litecoinecopool.org", "dnsseed.litecoinecopool.org"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("litecoinecotools.com", "testnet-seed.litecoinecotools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.litecoineco.loshan.co.uk", true));
        ...
        vFixedSeeds.push_back(lookupDomain("seedtest4.litecoineco.net",nDefaultPort));
        vFixedSeeds.push_back(lookupDomain("seedtest3.litecoineco.net",nDefaultPort));
        vFixedSeeds.push_back(lookupDomain("seedtest2.litecoineco.net",nDefaultPort));
        vFixedSeeds.push_back(lookupDomain("seedtest1.litecoineco.net",nDefaultPort));
