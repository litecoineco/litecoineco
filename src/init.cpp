...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/litecoineco/litecoineco>";
    const std::string URL_WEBSITE = "<https://litecoineco.net>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("LitecoinEco version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    connman.AddNode("seed1.litecoineco.net");
    connman.AddNode("seed2.litecoineco.net");
    connman.AddNode("seed3.litecoineco.net");
    connman.AddNode("seed4.litecoineco.net");
